...
class TripsDbConnector {
    async createNewTrip(tripDetails) {
        const sqlQuery = {
            text: `INSERT INTO trips (trip_code, from_city, to_city, booked_seats, stops, trip_date) 
            values ($1, $2, $3, $4, $5, $6)`,
            values: [tripDetails.trip_code, tripDetails.from_city, tripDetails.to_city, 
                tripDetails.booked_seats, tripDetails.stops, tripDetails.trip_date]
        };
